...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="form_add_tarif.php" class="btn-add"><i class="fa-solid fa-plus me-1"></i> Tambah Data</a>
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    echo "<td class='text-center'>
                        <a href='form_edit_tarif.php?Id={$row['id']}' class='text-primary fw-bold me-2'>Edit</a>
                        <a href='delete_data_tarif.php?Id={$row['id']}' class='text-danger fw-bold' onclick=\"return confirm('Yakin hapus data ini?')\">Hapus</a>
                    </td>";
