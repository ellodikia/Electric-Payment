...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="form_add_pelanggan.php" class="btn-add"><i class="fa-solid fa-plus me-1"></i> Tambah Data</a>
        <a href="search_komite.php" class="btn-search"><i class="fa-solid fa-search me-1"></i> Cari Data</a>
    </div>

    <div class="card card-table p-3">
        <h4 class="mb-3 fw-bold">Data Pelanggan</h4>
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    echo "<td class='text-center'>
                        <a href='form_edit_pelanggan.php?Id={$row['id']}' class='text-primary fw-bold me-2'>Edit</a>
                        <a href='delete_data_pelanggan.php?Id={$row['id']}' class='text-danger fw-bold' onclick=\"return confirm('Yakin hapus data ini?')\">Hapus</a>
                    </td>";
