...
<head>
    ...
    <title>Tambah Data Tarif | Electro Payment</title>
        ...
        <div class="col-lg-6">
            ...
            <div class="card p-4">
                ...
                <form action="insert_tarif.php" method="post">
                    ...
                    <input type="text" class="form-control" name="kodetarif" required>

                    <label class="form-label mt-3">Daya</label>
                    <input type="text" class="form-control" name="daya" required>
                ...
                <a href="data_tarif.php" class="btn btn-outline-secondary w-100 mt-3">
                    Kembali
                </a>
